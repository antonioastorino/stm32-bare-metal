/* The original file from STMMicroelectronics was downloaded from
 *    https://github.com/STMicroelectronics/cmsis-device-f1/blob/master/Include/stm32f103xb.h
 *
 * I slightly modified to remove its dependency from other headers
 */
